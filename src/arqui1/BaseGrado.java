 ...
 * @author Jhon
 */
public class BaseGrado extends javax.swing.JFrame {
...
private Bien2 icono6;
  ...
  public void mostrardatos4(String valor,String valor2){
    MiModelo modelo = new MiModelo();
    modelo.addColumn("CÓDIGO DE CARRERA");
    modelo.addColumn("CARRERA");
    modelo.addColumn("GESTIÓN");
    ...
    columnModel.getColumn(2).setCellRenderer(new MyRen());
    String sql="";
        sql="SELECT * FROM carrera where codigoCarrera='"+valor+"' AND gestion='"+valor2+"'ORDER BY codigoCarrera,nombre";
        ...
        customPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(customPanel1Layout.createSequentialGroup()
                ...
                .addGroup(customPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(botI, javax.swing.GroupLayout.DEFAULT_SIZE, 135, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        ...
        if(fila>= 0){
            //String sql="";
            aux1=tbCarrera.getValueAt(fila, 0).toString();
            aux2=tbCarrera.getValueAt(fila, 1).toString();
            aux3=tbCarrera.getValueAt(fila, 2).toString();
            mC m=new mC(new java.awt.Frame(), true);
            m.llenardatos(aux1, aux2,aux3);
            m.setVisible(true);
            mostrardatos4(m.getcodCarr(),m.getgestion());
        }else{
    ...
    private void botIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botIActionPerformed
        ...
        i.setVisible(true);
        mostrardatos4(i.getcodCarr(),i.getgestion());
