   ...
   public Conexion4(){
    ...
    public Connection conexion(){
        ...
        try {
            ...
            Conexion4=DriverManager.getConnection("jdbc:mysql://167.157.17.39:3306/interaccion2","user","cg01");
        } catch (Exception e) {
            Logger.getLogger(Conexion4.class.getName()).log(Level.SEVERE, null, e);
