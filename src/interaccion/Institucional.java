...
private Bien2 icono5;
    ...
    columnModel.getColumn(4).setCellRenderer(new MyRen());
    String sql="";
        sql="SELECT * FROM institucional WHERE gestion='"+valor+"' AND codigoP='"+valor2+"' ORDER BY codigoP,gestion";
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
       ...
       String aux5="";
        if(fila>= 0){
            ...
            aux4=tabI.getValueAt(fila, 3).toString();
            aux5=tabI.getValueAt(fila, 4).toString();
            mI m=new mI(new java.awt.Frame(), true);
            m.llenardatos(aux1, aux2, aux3, aux4, aux5);
            m.setVisible(true);
            mostrardatos8(m.getgest(),m.getcodPro());
        }else{
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
       ...
       String aux5="";
        if(fila>= 0){
            JOptionPane.showMessageDialog(null, "Al Eliminar un Proyecto Se Eliminan Todos los Convenios,Resultados,Postulantes Dependientes de este","",JOptionPane.WARNING_MESSAGE,icono);
            aux1=tabI.getValueAt(fila, 0).toString();
            aux2=tabI.getValueAt(fila, 1).toString();
            aux3=tabI.getValueAt(fila, 2).toString();
            aux4=tabI.getValueAt(fila, 3).toString();
            ...
            e.llenardatos(aux1, aux2, aux3, aux4, aux5);
            e.setVisible(true);
            mostrardatos8(e.getgest(),e.getcodPro());
        }else{
        JOptionPane.showMessageDialog(null, "No selecciono una fila","",JOptionPane.WARNING_MESSAGE,icono);
        }
    ...
    private void botIActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botIActionPerformed
        ...
        i.setVisible(true);
        mostrardatos8(i.getgest(),i.getcodPro());
