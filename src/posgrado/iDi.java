 ...
 * @author WildoJ
 */
public class iDi extends javax.swing.JDialog {
private Advertencia icono;
private Bien icono2;
private int contador1;
    public iDi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(439, 561, 109, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if((nom.getSelectedItem().toString()).equals("")||codDoc.getText().equals("")||mat.getText().equals("")||uT.getText().equals("")||act.getText().equals("")||cum.getText().equals("")||gestion.getText().equals("")){
            ...
            if(band==true){
                ...
                if(band==true){
                    try {
                        PreparedStatement pst2 = cn.prepareStatement ("DELETE FROM diplomado WHERE gestion='"+gestion.getText()+"' AND codDoc='"+""+"' AND materia='"+""+"' AND unidadtematica='"+""+"' AND actividad='"+""+"' AND nominacion='"+nom.getSelectedItem().toString()+"'");
                        pst2.executeUpdate();
                       } catch (Exception e) {
                        System.out.println(e.getMessage());
                       }
