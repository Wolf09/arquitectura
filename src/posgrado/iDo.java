 ...
 * @author WildoJ
 */
public class iDo extends javax.swing.JDialog {
private Advertencia icono;
private Bien icono2;
private int contador1;
    public iDo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
   ...
   public String getgestion(){
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(113, 551, 106, -1));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(458, 551, 109, -1));

        jPanel1.add(nom, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 520, 150, -1));

        jLabel14.setText("nominación:");
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(113, 523, -1, -1));
        ...
        jPanel1.add(cum, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 490, 105, -1));

        jLabel13.setText("% de Cumplimiento:");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(74, 492, -1, -1));
        jPanel1.add(fecF, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 460, 150, -1));

        jLabel12.setText("Fecha de Fin:");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(105, 456, -1, -1));
        jPanel1.add(fecI, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 430, 150, -1));

        jLabel11.setText("Fecha de Inicio:");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(94, 431, -1, -1));
        ...
        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(214, 361, 430, 53));

        jLabel10.setText("Actividad:");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(122, 361, -1, -1));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(214, 303, 430, 47));

        jLabel8.setText("Unidad Temática:");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(87, 303, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(214, 242, 430, 49));

        jLabel6.setText("Materia o Modulo:");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(84, 242, -1, -1));
        ...
        jPanel1.add(email, new org.netbeans.lib.awtextra.AbsoluteConstraints(214, 211, 430, -1));

        jLabel2.setText("email:");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(142, 214, -1, -1));
        ...
        jPanel1.add(telf, new org.netbeans.lib.awtextra.AbsoluteConstraints(214, 180, 430, -1));

        jLabel4.setText("teléfono:");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(126, 183, -1, -1));
        ...
        jPanel1.add(nD, new org.netbeans.lib.awtextra.AbsoluteConstraints(215, 149, 430, -1));

        jLabel20.setText("Nombres (Docente):");
        jPanel1.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(74, 155, -1, -1));
        ...
        jPanel1.add(aD, new org.netbeans.lib.awtextra.AbsoluteConstraints(215, 118, 430, -1));

        jLabel19.setText("Apellidos (Docente):");
        jPanel1.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(74, 124, -1, -1));

        jPanel1.add(grado, new org.netbeans.lib.awtextra.AbsoluteConstraints(215, 87, 430, -1));

        jLabel18.setText("Grado de Instrucción del Docente:");
        jPanel1.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(7, 90, -1, -1));
        ...
        jPanel1.add(codDoc, new org.netbeans.lib.awtextra.AbsoluteConstraints(215, 61, 430, -1));

        jLabel1.setText("Código Docente:");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(91, 64, -1, -1));
        ...
        jPanel1.add(gestion, new org.netbeans.lib.awtextra.AbsoluteConstraints(215, 30, 150, -1));

        jLabel3.setText("Gestión:");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(131, 33, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if((nom.getSelectedItem().toString()).equals("")||codDoc.getText().equals("")||mat.getText().equals("")||uT.getText().equals("")||act.getText().equals("")||cum.getText().equals("")||gestion.getText().equals("")){
            JOptionPane.showMessageDialog(this, "No ingreso datos ingrese porfavor, el codigo Docente,materia,Unidad tematica,actividad, % de cumplimiento, gestion, nominacion no pueden estar vacios","",JOptionPane.WARNING_MESSAGE,icono);
        }
        else{
            ...
            if(band==true){
                try {
                  ...
                  if(band==true){
                    try {
                        PreparedStatement pst2 = cn.prepareStatement ("DELETE FROM doctorado WHERE gestion='"+gestion.getText()+"' AND codDoc='"+""+"' AND materia='"+""+"' AND unidadtematica='"+""+"' AND actividad='"+""+"' AND nominacion='"+nom.getSelectedItem().toString()+"'");
                        pst2.executeUpdate();
                       } catch (Exception e) {
                        System.out.println(e.getMessage());
                       }
