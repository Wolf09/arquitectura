 ...
 * @author Jhon
 */
public class AreaTematica extends javax.swing.JFrame {
...
private Bien2 icono5;
    ...
    modelo.addColumn("CÓDIGO ÁREA TEMÁTICA");
    modelo.addColumn("ÁREA TEMÁTICA");
    modelo.addColumn("NOMINACIÓN");
    tabAreaT.setModel(modelo);
    TableColumnModel columnModel = tabAreaT.getColumnModel();
    ...
    {
        sql="SELECT institucional.gest,areatematica.codigoAT,areatematica.areaTematica,institucional.nomi FROM areatematica,institucional WHERE areatematica.gestion=institucional.gest AND areatematica.nominacion=institucional.nomi ORDER BY areatematica.codigoAT,institucional.gest";
    }
    else{
        sql="SELECT institucional.gest,areatematica.codigoAT,areatematica.areaTematica,institucional.nomi FROM areatematica,institucional WHERE areatematica.gestion=institucional.gest AND areatematica.nominacion=institucional.nomi AND areatematica.gestion='"+valor+"' AND areatematica.nominacion='"+valor2+"' ORDER BY areatematica.codigoAT,institucional.gest";
    }
    ...
    String []datos = new String [5];
        try {
            ...
            Logger.getLogger(AreaTematica.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    columnModel.getColumn(3).setCellRenderer(new MyRen());
    String sql="";
        sql="SELECT institucional.gest,areatematica.codigoAT,areatematica.areaTematica,institucional.nomi FROM areatematica,institucional WHERE areatematica.gestion=institucional.gest AND areatematica.nominacion=institucional.nomi AND areatematica.gestion='"+valor+"' AND areatematica.codigoAT='"+valor2+"' AND areatematica.nominacion='"+valor3+"' ORDER BY areatematica.codigoAT,institucional.gest";
    ...
    private void initComponents() {
        ...
        tabAreaT = new javax.swing.JTable();
        ...
        tabAreaT.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tabAreaT.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_NEXT_COLUMN);
        tabAreaT.setComponentPopupMenu(jPopupMenu1);
        jScrollPane1.setViewportView(tabAreaT);

        customPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ÁREA TEMÁTICA", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(255, 255, 0))); // NOI18N
                ...
                .addGroup(customPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(customPanel1Layout.createSequentialGroup()
                        .addGroup(customPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(cCAT, javax.swing.GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE)
                    ...
                    .addGroup(customPanel1Layout.createSequentialGroup()
                        .addComponent(cPG, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        int fila= tabAreaT.getSelectedRow();
        String aux1="";
        String aux2="";
        String aux3="";
        String aux4="";
        if(fila>= 0){
            aux1=tabAreaT.getValueAt(fila, 0).toString();
            aux2=tabAreaT.getValueAt(fila, 1).toString();
            aux3=tabAreaT.getValueAt(fila, 2).toString();
            aux4=tabAreaT.getValueAt(fila, 3).toString();
            mAT m=new mAT(new java.awt.Frame(), true);
            m.llenardatos(aux1, aux2, aux3, aux4);
            m.setVisible(true);
            mostrardatos8(m.getgestion(),m.getcodAT(),m.getnom());
        }else{
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        ...
        if(fila>= 0){
            ...
            aux3=tabAreaT.getValueAt(fila, 2).toString();
            aux4=tabAreaT.getValueAt(fila, 3).toString();
            eAT e=new eAT(new java.awt.Frame(), true);
            e.llenardatos(aux1, aux2, aux3, aux4);
            e.setVisible(true);
            mostrardatos8(e.getgestion(),e.getcodAT(),e.getnom());
        }else{
        JOptionPane.showMessageDialog(null, "No selecciono una fila","",JOptionPane.WARNING_MESSAGE,icono);
        }
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        ...
        if(fila>= 0){
            aux1=tabAreaT.getValueAt(fila, 0).toString();
            aux2=tabAreaT.getValueAt(fila, 3).toString();
            iAT i=new iAT(new java.awt.Frame(), true);
            i.llenardatos(aux1, aux2);
            i.setVisible(true);
            mostrardatos8(i.getgestion(),i.getcodAT(),i.getnom());
        }else{
        JOptionPane.showMessageDialog(null, "No selecciono una fila","",JOptionPane.WARNING_MESSAGE,icono);
        }
    ...
    columnModel.getColumn(3).setCellRenderer(new MyRen());
    String sql="";
        sql="SELECT institucional.gest,areatematica.codigoAT,areatematica.areaTematica,institucional.nomi FROM areatematica,institucional WHERE areatematica.gestion=institucional.gest AND areatematica.nominacion=institucional.nomi AND areatematica.codigoAT='"+valor+"' ORDER BY areatematica.codigoAT,institucional.gest";
    ...
    columnModel.getColumn(3).setCellRenderer(new MyRen());
    String sql="";
        sql="SELECT institucional.gest,areatematica.codigoAT,areatematica.areaTematica,institucional.nomi FROM areatematica,institucional WHERE areatematica.gestion=institucional.gest AND areatematica.nominacion=institucional.nomi AND areatematica.nominacion='"+valor+"' ORDER BY areatematica.codigoAT,institucional.gest";
    ...
    columnModel.getColumn(3).setCellRenderer(new MyRen());
    String sql="";
        sql="SELECT institucional.gest,areatematica.codigoAT,areatematica.areaTematica,institucional.nomi FROM areatematica,institucional WHERE areatematica.gestion=institucional.gest AND areatematica.nominacion=institucional.nomi AND institucional.gest='"+valor+"' ORDER BY areatematica.codigoAT,institucional.gest";
    ...
    private javax.swing.JTable tabAreaT;
