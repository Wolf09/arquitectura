 ...
 * @author WildoJ
 */
public class eDo extends javax.swing.JDialog {
private Advertencia icono;
private Bien icono2;
    public eDo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(codDoc, new org.netbeans.lib.awtextra.AbsoluteConstraints(222, 59, 410, -1));
        ...
        jPanel1.add(grado, new org.netbeans.lib.awtextra.AbsoluteConstraints(222, 85, 410, -1));
        ...
        jPanel1.add(aD, new org.netbeans.lib.awtextra.AbsoluteConstraints(222, 116, 410, -1));
        ...
        jPanel1.add(nD, new org.netbeans.lib.awtextra.AbsoluteConstraints(222, 147, 410, -1));
        ...
        jPanel1.add(telf, new org.netbeans.lib.awtextra.AbsoluteConstraints(222, 178, 410, -1));
        ...
        jPanel1.add(email, new org.netbeans.lib.awtextra.AbsoluteConstraints(222, 209, 410, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(222, 240, 410, 49));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(222, 301, 410, 47));
        ...
        jPanel1.add(cum, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 490, 105, -1));

        fecF.setEnabled(false);
        jPanel1.add(fecF, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 450, 150, -1));
        ...
        jPanel1.add(fecI, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 420, 150, -1));

        jLabel11.setText("Fecha de Inicio:");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(93, 429, -1, -1));

        jLabel14.setText("nominación:");
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(112, 521, -1, -1));

        nom.setEnabled(false);
        jPanel1.add(nom, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 520, 150, -1));
        ...
        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(222, 359, 410, 53));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(424, 549, 109, -1));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(112, 549, 104, -1));
        ...
        jPanel1.add(gestion, new org.netbeans.lib.awtextra.AbsoluteConstraints(225, 28, 120, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            PreparedStatement pst = cn.prepareStatement ("DELETE FROM doctorado WHERE gestion='"+gestion.getText()+"' AND codDoc='"+codDoc.getText()+"' AND materia='"+mat.getText()+"' AND unidadtematica='"+uT.getText()+"' AND actividad='"+act.getText()+"' AND nominacion='"+nom.getSelectedItem().toString()+"'");
            pst.executeUpdate();
