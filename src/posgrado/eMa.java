 ...
 * @author WildoJ
 */
public class eMa extends javax.swing.JDialog {
private Advertencia icono;
private Bien icono2;
    public eMa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(codDoc, new org.netbeans.lib.awtextra.AbsoluteConstraints(212, 59, 420, -1));
        ...
        jPanel1.add(grado, new org.netbeans.lib.awtextra.AbsoluteConstraints(212, 85, 420, -1));
        ...
        jPanel1.add(aD, new org.netbeans.lib.awtextra.AbsoluteConstraints(212, 116, 420, -1));
        ...
        jPanel1.add(nD, new org.netbeans.lib.awtextra.AbsoluteConstraints(212, 147, 420, -1));
        ...
        jPanel1.add(telf, new org.netbeans.lib.awtextra.AbsoluteConstraints(212, 178, 420, -1));
        ...
        jPanel1.add(email, new org.netbeans.lib.awtextra.AbsoluteConstraints(212, 209, 420, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(212, 240, 420, 49));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(212, 301, 420, 47));
        ...
        jPanel1.add(fecF, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 450, 150, -1));
        ...
        jPanel1.add(fecI, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 420, 150, -1));
        ...
        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(212, 359, 420, 53));
        ...
        jPanel1.add(gestion, new org.netbeans.lib.awtextra.AbsoluteConstraints(215, 28, 130, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            PreparedStatement pst = cn.prepareStatement ("DELETE FROM maestria WHERE gestion='"+gestion.getText()+"' AND codDoc='"+codDoc.getText()+"' AND materia='"+mat.getText()+"' AND unidadtematica='"+uT.getText()+"' AND actividad='"+act.getText()+"' AND nominacion='"+nom.getSelectedItem().toString()+"'");
            pst.executeUpdate();
