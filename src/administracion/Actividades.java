...
public class Actividades extends javax.swing.JFrame {
    ...
    public void mostrardatos8(String valor,String valor2,String valor3) {
        ...
        columnModel.getColumn(14).setCellRenderer(new MyRen2(9,10));
        String sql = "";
            sql = "SELECT actividades.gestion,actividades.codA,actividades.grado,actividades.apellidos,actividades.nombres,actividades.email,actividades.telf,actividades.cargo,actividades.dependencia,actividades.act,actividades.fInicio,actividades.fFinal,actividades.cump,actividades.pp,actividades.sp,actividades.pf,actividades.respR FROM actividades WHERE actividades.gestion='"+valor+"' AND actividades.codA='" + valor2 + "' AND actividades.act='"+valor3+"' ORDER BY actividades.apellidos, actividades.nombres";
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        if (fila >= 0) {
                ...
                sql = "select grado, apellidos, nombres from actividades where gestion='"+tabA.getValueAt(fila, 0).toString()+"' AND codA='" +tabA.getValueAt(fila, 1).toString()+ "' AND act='"+tabA.getValueAt(fila, 7).toString()+"'";
                try {
                    Statement st = cn.createStatement();
                    ResultSet rs = st.executeQuery(sql);
                    while (rs.next()) {
                ...
                aux10=tabA.getValueAt(fila, 14).toString();
                iA i=new iA(new java.awt.Frame(), true);
                i.llenardatos(aux1, aux2, aux3, aux4, aux5, aux6, aux7, aux8, aux9, formato.format(fecha1), formato.format(fecha1), "0", aux10);
                i.setVisible(true);
                mostrardatos8(i.getgestion(),i.getcodA(),i.getact());
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        ...
        if (fila >= 0) {
                ...
                m.setVisible(true);
               mostrardatos8(m.getgestion(),m.getcodA(),m.getact());
        } else {
            JOptionPane.showMessageDialog(null, "No selecciono una fila", "", JOptionPane.WARNING_MESSAGE, icono);
        }
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        ...
        String aux14="";
        if (fila >= 0) {
                JOptionPane.showMessageDialog(null, "Al Eliminan todas las Sub-Actividades y Evaluaciones Dependientes de este","",JOptionPane.WARNING_MESSAGE,icono);
                aux1=tabA.getValueAt(fila, 0).toString();
                aux2=tabA.getValueAt(fila, 1).toString();
                sql = "select grado, apellidos, nombres from actividades where gestion='"+tabA.getValueAt(fila, 0).toString()+"' AND codA='" +tabA.getValueAt(fila, 1).toString()+ "' AND act='"+tabA.getValueAt(fila, 7).toString()+"'";
                try {
                ...
                e.setVisible(true);
                mostrardatos8(e.getgestion(),e.getcodA(),e.getact());
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
       ...
       if (fila >= 0) {
           ...
           SubActividades s= new SubActividades();
    ...
    private void jMenuItem9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem9ActionPerformed
       Report r=new Report(new java.awt.Frame(), true,this.cn,"RActividades.jasper");
        r.setVisible(true);
