   ...
   public Conexion3(){
    ...
    public Connection conexion(){
        ...
        try {
            ...
            Conexion3=DriverManager.getConnection("jdbc:mysql://167.157.17.39:3306/investigacion2","user","cg01");
        } catch (Exception e) {
            Logger.getLogger(Conexion3.class.getName()).log(Level.SEVERE, null, e);
